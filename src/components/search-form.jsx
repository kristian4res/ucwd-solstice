  ...
  return (
    ...
    >
        <div className='form-group relative'>
            ...
            <input className='outline-none px-2 py-1 text-base' 
                ...
                required 
            />
            <ul className='p-2 absolute top-full rounded-lg shadow-xl bg-white text-dark'>
                {
                    // trips.filter((val) => {
                    //     if (searchedLocation === '') {
                    //         return null;
                    ...
                    //     }
                    // }).map((val, key) => {
                    //     return <li key={key} className='hover:bg-slate-200 cursor-pointer'>{val.name}</li>
                    // })
                }
            </ul>
        </div>
