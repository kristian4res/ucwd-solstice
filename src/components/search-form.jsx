...
const SearchForm = () => {
  return (
    <div className='container shadow-2xl w-fit px-2 py-2 grid auto-rows-auto grid-cols-1 rounded-lg bg-white mt-8 sm:grid-cols-2 md:place-content-evenly md:mt-4 xl:grid-cols-5'>
        <div className='flex flex-col h-full mx-2 py-2 px-2'>
